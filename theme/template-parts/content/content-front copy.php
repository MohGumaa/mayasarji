...
<section 
  id="hero"
  class="relative w-full bg-black/30 h-svh overflow-hidden">
  ...
  <div id="ms-slides">
    <div class="ms-slide active">
      ...
      <div class="ms-slide-img">
        <img src="https://mayasarji.com/wp-content/uploads/2026/05/img-5.webp" alt="<?php esc_html_e( 'Recording Studio', 'mayasarji' );?>">
      </div>
  ...
  <div class="absolute bottom-6 left-0 right-0 z-20 container">
    <div id="ms-dots" class="flex items-center gap-2.5">
      <button class="ms-dot active" data-index="0" aria-label="Slide 1"></button>
      <button class="ms-dot" data-index="1" aria-label="Slide 2"></button>
    </div>
  </div>
</section>
